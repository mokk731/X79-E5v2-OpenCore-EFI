...
### X79-H67-E5v2-DmitriyyyyS20250101.zip
    ...
    **完全复制ACPI, DeviceProperties 也不行，不能进入安装菜单
...
## X79-H67-E5v2-DmitriyyyyS20260619.zip

用 https://github.com/lzhoang2801/OpCore-Simplify 做EFI,不能进入选择菜单，能做SSDT-EC.aml, SSDT-SBUS.aml 。

挂到 X79-H67-E5v2-DmitriyyyyS20250101.zip  \EFI\OC\ACPI ，能进入选择菜单，能进入安装菜单，但多次试安装macos,不成功,安装到最后3分钟，就自动重启， 还没到选国家。
放弃了。
